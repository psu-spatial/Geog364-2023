...
temporarily saves the data into a table called 'frost'.  That's what the 'arrow' is doing in the command.  It does the stuff on the right (loads the file from excel, then the arrow means 'store this as' frost)

This code will only work if - you have run your library code chunk and if you
have downloaded the readxl library - if your file really is in your lab
2 folder - If you are running your project
...
are going to focus on the ggplot2 and the tmap packages.
...
2.  <br> We can improve it very easily. Try running this code.
...
ggplot(frost, aes(x=Avg_DOY_SpringFrost)) +
       ...
       xlab("Number of weather stations") 
```
...
Finally, we can use the tmap package

<br><br><br>

# UFO Analysis

Congrats! If you have reached this far, you have at least received a B
:)

To be added later today. Focus on steps 1-9 for now - and you have all
lab next week for this part.
