...
temporarily saves the data into a table called 'frost'

This will only work if - you have run your library code chunk and if you
...
NAME to take a look (see screenshot below). You will see a
spreadsheet/table/data.frame with these columns:
...
Each row represents a weather station.
