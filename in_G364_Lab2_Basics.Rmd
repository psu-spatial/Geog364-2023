...
green arrow to run. This will only work if you have run your library
code chunk, if your file really is in your lab 2 folder and if you have
downloaded the readxl library.

You should see the data appear in the 'environment tab'. Click the NAME
to take a look.
