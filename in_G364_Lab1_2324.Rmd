...
3 - CORRECT LINK](https://psu-spatial.github.io/Geog364-2023/in_Tutorial03LabSetUp.html)
...
Create a separate code chunk for each problem below. Inside **use R
code** to calculate the answers. You HAVE to show the code! <br><br>
...
4](https://psu-spatial.github.io/Geog364-2023/in_Tutorial04ConsoleBasics.html)
