...
It will ask you to name your file. Give it a relevant name including your email ID, like Lab-2_hlg5155.

```{r, fig21b, echo=FALSE,fig.align='center',out.width="80%"}
knitr::include_graphics('./Figures/fig21b_Markdown.png')
```

Press OK. A new file should appear on your screen.
...
```{r, fig21c, echo=FALSE,fig.align='center'}
knitr::include_graphics('./Figures/fig21c_Markdown.png')
```
