...
Feel free to install any additional libraries you need
...
In your own words, explain the difference between a Monte Carlo approach and a theoretical approach to the hypothesis test.
...
Change the critical threshold to 0.01, and to 0.1 and to 0.5.  Each time, re-run the LISA code (everything including and below the critical code chunk, or run-all). Explain what is happening in terms of ozone pollution in California. <br>
